...
public class RequestOrder {
    ...
    int userId, requestId, makerId, requestedQty;
        ...
        public RequestOrder(int userId, int requestId, int makerId, Uri userPic, Uri requestPic, String userName, String requestDetails, String requestCategory, String requestType, String requestSize, int requestedQty, String requestColor, String requestedDate, String requestStatus) {
            this.userId = userId;
