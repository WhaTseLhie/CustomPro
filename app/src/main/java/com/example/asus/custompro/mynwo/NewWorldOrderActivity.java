package com.example.asus.custompro.mynwo;
...
public class NewWorldOrderActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
...
//        if(!orderList.isEmpty()) {
//            if (orderList.get(0).getNwoStatus().equals("PROCESSING") || orderList.get(0).getNwoStatus().equals("ON-HOLD")) {
//            }
//        }
