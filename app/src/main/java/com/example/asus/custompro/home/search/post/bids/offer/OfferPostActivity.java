...
public class OfferPostActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                OfferPostActivity.this.setResult(RESULT_OK, deleteIntent);
        ...
        switch(v.getId()) {
            ...
            case R.id.button:
                ...
                if(TextUtils.isEmpty(comment)) {
                    ...
                    //db.addPostOffer(userId, postId, shopId, shopPic, shopName, price, date, comment);
                    Intent b = new Intent();
