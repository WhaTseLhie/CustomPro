...
public class RequestOrderAdapter extends BaseAdapter {

    Context context;
    ArrayList<RequestOrder> list;
    LayoutInflater inflater;

    public RequestOrderAdapter(Context context, ArrayList<RequestOrder> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.adapter_request_order, null);
