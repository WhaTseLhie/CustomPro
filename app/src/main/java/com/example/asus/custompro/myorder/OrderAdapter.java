...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        handler.txtDate.setText("Date: " +list.get(position).getOrderDate());
        handler.txtMade.setText("Made: " +list.get(position).getOrderMade());
        handler.txtStatus.setText("Status: " +list.get(position).getOrderStatus());
